        ...
        return (
            <div className="main-container">
                ...
                <div className='flex-table row'>
                    <div className="text-containers">
                        <div className="rounded-box">
                            ...
                            <p align='justify'>
                                ...
                                (<a href='https://www.damnvulnerabledefi.xyz/'>Tinchoabbate Damn Vulnerable Defi</a>, etc).
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-containers">
                        <div className="rounded-box">
                            <p align='left'><b>How do I win?</b></p>
                            <p align='justify'>
                                ...
                                Harder challenges are worth more points. Each challenge is in the form of a smart contract with an isComplete function.
                                The goal is always to make isComplete() return TRUE.<br /><br />
                    ...
                    <div className="text-containers">
                        <div className="rounded-box">
                            <p align='left'><b>How to contribute?</b></p>
                            <p align='justify'>PR your own smart contract challenge to the <a href='https://github.com/devnet0x/Starknet-Security-Challenges-Factory/'>
                                github reposiroty</a> and i will try to add it as son as possible. <br /><br />
                                The only requirement is that your Cairo Smart Contract must have a isComplete() external
                                function with return TRUE if challenge was succesfully completed.
                            </p>
                        </div>
                    </div>
                ...
                <footer>
                    <p>created by <a href='https://twitter.com/devnet0x/'>@devnet0x</a></p>
                </footer>
        ...
        return (
            <div className="main-container">
                ...
                <div className='flex-table row'>
                    <div className="text-containers">
                        <div className="rounded-box">
                            <p align='left'><b>¿Qué es esto?</b></p>
                            <p align='justify'>
                    ...
                    <div className="text-containers">
                        <div className="rounded-box">
                            <p align='left'><b>¿Como puedo jugar?</b></p>
                            <p align='justify'>
                                ...
                                Además, hay un tabla de clasificación (leaderboard) (y no te preocupes por los upgrades porque el contrato inteligente principal fue implementado con un proxy).
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="text-containers">
                        <div className="rounded-box">
                            <p align='left'><b>¿Cómo contribuir?</b></p>
                            <p align='justify'>PR tu propio reto con un contrato inteligente en el <a href='https://github.com/devnet0x/Starknet-Security-Challenges-Repo'>
                                ...
                                si el reto fue completado exitosamente.
                            </p>
                        </div>
                    </div>
