...
function Challenge2Deploy() {
    ...
    return (
      <>
        ...
        {data && data.status=="ACCEPTED_ON_L2" && data.events?<div> <Challenge2Check /> </div>:<div></div>}
       </>
    )
}
...
The “Begin Challenge” button will deploy the following contract, call the function named callme and then click the “Check Solution” button.<br /><br />
